...
export function inputChange(valueToChange, newValue) { return({type: INPUT_CHANGE, payload: [valueToChange, newValue]}) }
...
export function postQuiz(quizObj) {
  return function (dispatch) {
    axios.post('http://localhost:9000/api/quiz/new', quizObj)
      .then(res => {
