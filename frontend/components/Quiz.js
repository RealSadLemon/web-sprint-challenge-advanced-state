...
import { setQuiz, selectAnswer, setMessage, postAnswer } from '../state/action-creators'
          ...
          <>
            ...
            <div id="quizAnswers">
              <div className={`answer${props.selectedAnswer === props.quiz.answers[0].answer_id ? ' selected' : ''}`}>
                ...
                <button id={props.quiz.answers[0].answer_id} onClick={selectAnswer}>
              ...
              <div className={`answer${props.selectedAnswer === props.quiz.answers[1].answer_id ? ' selected' : ''}`}>
                ...
                <button id={props.quiz.answers[1].answer_id} onClick={selectAnswer}>
                  {props.selectedAnswer === props.quiz.answers[1].answer_id ? 'SELECTED' : 'Select'}
                </button>
              </div>
            </div>

            <button id="submitAnswerBtn" disabled={canSubmit} onClick={handleSubmit} >Submit answer</button>
          </>
        ) : 'Loading next quiz...'
      }
    </div>
...
export default connect(mapStateToProps, { setQuiz, selectAnswer, setMessage, postAnswer })(Quiz);